...
const volumeControlFireplace = document.querySelector('.volume-control-fireplace')

const wrapperInputRangeForest = document.querySelector('.wrapper-input-range-forest')
const wrapperInputRangeRain = document.querySelector('.wrapper-input-range-rain')
const wrapperInputRangeCafeteria = document.querySelector('.wrapper-input-range-cafeteria')
const wrapperInputRangeFireplace = document.querySelector('.wrapper-input-range-fireplace')
